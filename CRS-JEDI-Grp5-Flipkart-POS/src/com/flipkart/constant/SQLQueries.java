...
public class SQLQueries {
    ...
    //AdminDao Queries
    public static final String PAYMENT_STATUS_STUDENT = "SELECT courseCode from payment where studentid = ?";
    ...
    */
    ...
    public static final String ALREADY_REGISTERED_COURSES_PROFESSOR="select * from coursecatalog where instructorid=?";
